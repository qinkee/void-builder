...
export VSCODE_CLI_DOWNLOAD_URL="https://github.com/TIMtechnology/void/releases"
export VSCODE_CLI_QUALITY="stable"
export VSCODE_CLI_UPDATE_URL="https://raw.githubusercontent.com/TIMtechnology/versions/refs/heads/main"
